...
public class Dekompression {
    ...
    public static String Dekomprimera(String kod){
        ...
        //Gör en variant dör vi konvertera char till string för senare jämföresle
        ...
        if (Character.isDigit(i)){
            ...
            //Denna ska upp till number på nåt sätt va?
        ...
        //Denna kanske blir överflödig om man alltid tar bort slutparentes i tidigare fall?
        else if (Objects.equals(k, ")" )){
            kod = kod.substring(1);
            System.out.println(kod);
        }
